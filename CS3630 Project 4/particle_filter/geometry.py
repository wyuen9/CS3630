...
class SE2:
    ...
    def transform_point(self, point: Point) -> Point:
        ...
        transformed_homogeneous = np.dot(self.T, point_homogeneous)

        new_x = transformed_homogeneous[0]
        new_y = transformed_homogeneous[1]
    ...
    def compose(self, other: 'SE2') -> 'SE2':
        ...
        new_pose = None
        ######### START STUDENT CODE #########
        composed_matrix = np.dot(self.T, other.T)
    ...
    def inverse(self) -> 'SE2':
        ...
        new_x = T_inv[0, 2]
        new_y = T_inv[1, 2]
        new_h = math.atan2(T_inv[1, 0], T_inv[0, 0])
